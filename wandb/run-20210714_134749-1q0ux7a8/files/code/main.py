...
if __name__ == '__main__':
    ...
    plot_learning_curve_average(x, score_history, "temp\\learning_curve_average_torch_ppo_2.1.jpg")
    plot_learning_curve(x, score_history, "temp\\learning_curve_torch_ppo_2.1.jpg")
